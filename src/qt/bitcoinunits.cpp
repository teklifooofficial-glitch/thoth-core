...
QString BitcoinUnits::longName(int unit)
{
    switch(unit)
    {
    case BTC: return QString("TTH");
    case mBTC: return QString("mTTH");
    case uBTC: return QString("uTTH");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("Thoth (1)");
    case mBTC: return QString("Milli-Thoth (1 / 1" THIN_SP_UTF8 "000)");
    case uBTC: return QString("Micro-Thoth (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
