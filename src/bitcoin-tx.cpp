...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " thoth-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  thoth-tx [options] <hex-tx> [commands]  Update hex-encoded thoth transaction\n" +
            "or:     thoth-tx [options] -create [commands]   Create hex-encoded thoth transaction\n" +
            "\n";
