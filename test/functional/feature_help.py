...
"""Verify that starting thoth with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start thoth with -h for help text")
        ...
        self.log.info("Start thoth with -version for version information")
        ...
        self.log.info("Start thothd with -fakearg to make sure it does not start")
