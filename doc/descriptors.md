# Support for Output Descriptors in Thoth Core

Since Thoth Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `tth1...` for mainnet or `ttth1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
existing Thoth Core wallets, a convenience function `combo` is
