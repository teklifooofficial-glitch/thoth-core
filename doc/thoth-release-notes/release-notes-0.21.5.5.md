Thoth Core version 0.21.5.5 is now available from:

 <https://download.thoth.org/thoth-0.21.5.5/>.
...
- Replaced the functional test dependency on the external `thoth_scrypt`
