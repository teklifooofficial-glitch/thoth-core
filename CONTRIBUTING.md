Contributing to Thoth Core
============================

The Thoth Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the Thoth Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/thoth-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to thoth-qt
...
The following applies to code changes to the Thoth Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Thoth
Network Protocol consensus changes.

Whether a pull request is merged into Thoth Core rests with the project merge
...
Patches that change Thoth consensus rules are considerably more involved than
...
Where a patch set proposes to change the Thoth consensus, it must have been
...
The project leader is the release manager for each Thoth Core release.
